...
- `@shallot-ui/web` &mdash; React Web Components
  - Get it from [npm](https://www.npmjs.com/package/@shallot-ui/web) with `yarn add @shallot-ui/web` or `npm install @shallot-ui/web`
