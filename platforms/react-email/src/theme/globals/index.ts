...
export const REACT_EMAIL_THEME_GLOBALS = makeThemeGlobals({
...
export const makeReactEmailThemeGlobals = <T extends Readonly<ThemeGlobals>>(
  tokens?: T,
) => mergeThemeGlobals(REACT_EMAIL_THEME_GLOBALS, tokens)
