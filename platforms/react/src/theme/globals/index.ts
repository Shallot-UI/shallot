...
export const REACT_THEME_GLOBALS = makeThemeGlobals({
...
export const makeReactThemeGlobals = <T extends Readonly<ThemeGlobals>>(
  tokens?: T,
) => mergeThemeGlobals(REACT_THEME_GLOBALS, tokens)
